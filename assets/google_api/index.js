  ...
  for (const place of places) {
    ...
    if (resultCount < 5) {
      ...
      if (place.geometry && place.geometry.location) {
        ...
        service.getDetails(request, (thisPlace, status) => {
          ...
          li.textContent = thisPlace.name;
          placesList.appendChild(li);
          li.addEventListener("click", () => {
            map.setCenter(thisPlace.geometry.location);
          });
          ...
          google.maps.event.addListener(marker, "click", () => {
            ...
            nameElement.textContent = thisPlace.name;
            ...
            placeImageElement.src = place.photos[0].getUrl({maxWidth: 250, maxHeight: 250});
            content.appendChild(placeImageElement);

            const placeAddressElement = document.createElement("p");
            placeAddressElement.textContent = thisPlace.formatted_address;
